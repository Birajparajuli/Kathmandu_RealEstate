							...
							?>
                                <div class="col-md-6">
                                    <div class="featured-thumb hover-zoomer mb-4">
                                        <div class="overlay-black overflow-hidden position-relative" id="myCard"> <img
                                            ...
                                            <div class="price text-primary text-capitalize">रु.
                                                <?php echo $row['price'];?>
                                                <span class="text-white"><?php echo $row['built_area'];?></span>
                                            </div>
                                        </div>
                                ...
                                <?php } ?>
                                <!-- Pagination Implementation  -- Future Task -->
                                <!--    <div class="col-md-12">
