            ...
            <div class="row">
                <div class="col-lg-12">
                    <nav class="navbar navbar-expand-lg navbar-light p-0"> <a class="navbar-brand position-relative"
                            href="index.php">
                            <img class="nav-logo" src="images\logo\color-logo.png" alt="" style="height:65px;"></a>
                            ...
                            <ul class="navbar-nav mr-0">
                                ...
                                <li class="nav-item dropdown">
                                    ...
                                    <ul class="dropdown-menu">
                                        ...
                                        <li class="nav-item"> <a class="nav-link" href="feature.php">Your Properties</a>
                                        <li class="nav-item"> <a class="nav-link" href="inquirylist.php">Inquiries</a>
                                        </li>
