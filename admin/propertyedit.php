                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control" id="category" name="category" required>
                                        ...
                                        <option value="Apartment"
                                            <?php if ($row['3'] == 'Apartment') echo 'selected'; ?>>
                                            Apartment
                                        </option>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <select class="form-control" id="parking" name="parking">
                                        <option value="Moterbike"
                                            <?php if ($row['10'] == 'Moterbike') echo 'selected'; ?>>
                                            Moterbike
                                        </option>
                                        ...
                                        <option value="Car-5" <?php if ($row['10'] == 'Car-5') echo 'selected'; ?>>Car
                                            (5)</option>
                                        <option value="Car-6-10"
                                            <?php if ($row['10'] == 'Car-6-10') echo 'selected'; ?>>Car
                                            (6-10)
                                        </option>
                                    </select>
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control" name="status">
                                ...
                                <option value="Not Available"
                                    <?php if ($row['31'] == 'Not Available') echo 'selected'; ?>>
