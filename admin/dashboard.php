                ...
                <div class="col-xl-3 col-sm-6 col-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="dash-widget-info">
                                <h3><?php $sql = "SELECT * FROM property_list";
										$query = $con->query($sql);
                						echo "$query->num_rows";?></h3>
                ...
                <div class="col-xl-3 col-sm-6 col-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="dash-widget-info">
                                <h3><?php $sql = "SELECT * FROM property_list where category = 'House'";
										$query = $con->query($sql);
                						echo "$query->num_rows";?></h3>
                ...
                <div class="col-xl-3 col-sm-6 col-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="dash-widget-info">
                                <h3><?php $sql = "SELECT * FROM property_list where category = 'Apartment'";
										$query = $con->query($sql);
                						echo "$query->num_rows";?></h3>
                ...
                <div class="col-xl-3 col-sm-6 col-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="dash-widget-info">
                                <h3><?php $sql = "SELECT * FROM property_list where category = 'Building'";
										$query = $con->query($sql);
                						echo "$query->num_rows";?></h3>
                ...
                <div class="col-xl-3 col-sm-6 col-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="dash-widget-info">
                                <h3><?php $sql = "SELECT * FROM property_list where sale_rent = 'Sale'";
										$query = $con->query($sql);
                						echo "$query->num_rows";?></h3>
                ...
                <div class="col-xl-3 col-sm-6 col-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="dash-widget-info">
                                <h3><?php $sql = "SELECT * FROM property_list where sale_rent = 'Rent'";
										$query = $con->query($sql);
                						echo "$query->num_rows";?></h3>
